...
/>
        ...
        {/* Menú escritorio */}
        <nav className="hidden md:flex gap-6 text-gray-700" aria-label="Menú principal">
        ...
        {/* Botón menú móvil */}
        <button
          className="md:hidden flex flex-col gap-1.5 focus:outline-none focus:ring-2 focus:ring-psicopiloto-700 rounded"
      ...
      {open && (
        <nav
          className="md:hidden bg-white border-t border-gray-200 flex flex-col p-4 space-y-4 text-gray-700"
