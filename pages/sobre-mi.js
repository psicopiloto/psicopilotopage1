...
          <section className="mb-20 grid md:grid-cols-2 gap-12 items-center">
            {/*
              ...
              * Texto: Añadido "order-2 md:order-none"
              * (En móvil es el 2º, en escritorio 'md' respeta el orden del código)
            */}
...
            </div>
            {/*
              * CAMBIO APLICADO AQUÍ:
              * Imagen: Añadido "order-1 md:order-none"
              * (En móvil es el 1º, en escritorio 'md' respeta el orden del código)
            */}
