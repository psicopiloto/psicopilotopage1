...
export default function SobreMi() {
  const fasesTrayectoria = [
    ...
    },
    {
      ...
      content: [
        "En 2007 mi vida dio un giro de 180 grados y entré en la Academia General del Aire. He acumulado más de 2.500 horas de vuelo como piloto comandante en misiones de alto riesgo de extinción de incendios forestales en España, Grecia y Portugal[cite: 5]. En esa cabina, rodeado de condiciones extremas, la supervivencia dependía de dos cosas: aplicar procedimientos estrictos y mantener una calma mental absoluta cuando el cuerpo te pide entrar en pánico.",
        "Como instructor de vuelo y simulador, y posteriormente como Jefe de Crew Resource Management (CRM), mi prioridad absoluta en Factores Humanos era liderar un espacio seguro[cite: 5]. Aprendí que la verdadera seguridad en cabina nace de construir un ambiente de confianza absoluta donde cada miembro de la tripulación pueda comunicarse con honestidad y expresar lo que piensa sin el menor miedo a ser juzgado, optimizando la toma de decisiones ante la incertidumbre[cite: 5].",
      ],
    },
    {
      ...
      content: [
        "A pesar de la intensidad del vuelo, sabía que mi verdadera misión estaba en tierra. Tras obtener mi habilitación oficial para el ejercicio de la la Psicología General Sanitaria en 2015[cite: 2], decidí volcar toda mi experiencia en factores humanos, gestión de crisis y liderazgo en el campo de la psicoterapia profunda[cite: 2].",
        "Consolidé mi formación de postgrado como Experto en Psicopatología Integradora (UDIMA) y Experto Universitario en Intervención en Trauma y EMDR (UNIR)[cite: 2]. En septiembre de 2025 regresé definitivamente a Granada para estructurar una práctica psicoterapéutica rigurosa que responde al sufrimiento emocional, los trastornos de la conducta alimentaria (TCA) y las heridas de apego[cite: 2].",
        "Hoy divido mi actividad profesional entre la psicoterapia presencial en la <a href='https://medifamilia.es/' target='_blank' rel='noopener noreferrer' class='font-bold text-psicopiloto-green-600 hover:underline'>Medifamilia</a> en Granada —donde acompaño a adultos a procesar el trauma, el duelo, los trastornos alimentarios (TCA) o a resolver problemas de ansiedad, baja autoestima y heridas de apego—, mi consulta sanitaria online <strong>Psicopiloto</strong> —enfocada en esos mismos pilares de intervención a través de la telepsicología—, y mi participación como psicólogo experto en el área de CRM y Factores Humanos dentro de comités multidisciplinares para la selección y evaluación de pilotos en compañías aéreas internacionales de la mano de Resource Group[cite: 2, 5]. En estos comités, junto a los equipos de operaciones y recursos humanos, aplico evaluaciones basadas en la evidencia (EBT) y el entrenamiento por competencias conforme a los exigentes criterios regulados por las autoridades de aviación civil[cite: 2, 5].",
        "Además, sigo vinculado a la docencia especializada como profesor titular y tutor de proyectos de investigación (TFE) en el programa de Experto en Psicología Aeronáutica del Colegio Oficial de la Psicología de Madrid[cite: 2].",
        "<strong>Psicopiloto</strong> es la unión exacta de mis dos pasiones. En la cabina aprendí a sostener la presión; en la psicología, a sanar las tormentas internas[cite: 2].",
      ],
    },
    {
          ...
          <section className="mb-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-psicopiloto-gray-700 text-base leading-relaxed">
                Mi nombre es <strong>Jose Carlos Rguez. Retamar</strong>. Durante casi dos décadas operé en entornos de alta exigencia, gobernando aviones en misiones críticas de emergencia[cite: 2, 5]. Esa experiencia me enseñó algo que no se estudia en las facultades: que las peores turbulencias, las tormentas más devastadoras y los incendios más difíciles de apagar no ocurren ahí arriba, sino <strong>dentro del mundo interno de las personas</strong>.
              </p>
              <p className="text-psicopiloto-gray-700 text-base leading-relaxed mt-4">
                En una cabina de vuelo aprendes a analizar los sistemas de alarma sin dejarte arrastrar por el pánico[cite: 2, 5]. Pero la lección más profunda que trasladé a tierra es que la estabilidad real depende de la confianza[cite: 5]. Del mismo modo que un vuelo seguro exige una cabina libre de amenazas donde la tripulación pueda hablar con total transparencia, en mi consulta construyo un vínculo clínico idéntico: un espacio de absoluta seguridad donde puedas desnudarte emocionalmente, comprender tus alarmas somáticas y procesar tu historia con la total certeza de que no vas a ser juzgado[cite: 5]. Mi labor es darte ese entorno protegido y un procedimiento estructurado para recuperar el rumbo.
              </p>
            </div>
