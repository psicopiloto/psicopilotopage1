  ...
  return (
    <div className='min-h-screen flex flex-col'>
      ...
      <main className="flex-grow pt-16">
        <section className="relative h-[62vh] flex items-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1600&q=80')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
