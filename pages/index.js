...
import Image from "next/image"; // ✅ para las imágenes
      ...
      <main className="flex-grow pt-16 relative z-10">
        ...
        <section className="py-16 bg-white/40">
          <div className="container mx-auto max-w-5xl">
            <div className="grid md:grid-cols-2 gap-8 items-center p-6 bg-white/70 rounded-lg shadow-md">
              {/* Imagen izquierda */}
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center p-6 bg-white/70 rounded-lg shadow-md">
              ...
              <div className="text-left order-2 md:order-1">
                ...
                <p className="leading-relaxed mb-4 text-psicopiloto-gray-500">
                  ...
                  <strong>psicología integradora</strong>, <strong>trauma</strong>{" "}
                  y <strong>EMDR</strong> con una visión clara: cada persona es
                  única y merece ser escuchada con respeto y cercanía.
                </p>
                <AnimatedCTA
                  href="/sobre-mi"
                  text="Conóceme mejor"
        ...
        <section className="py-16 bg-white/40">
          <div className="container mx-auto text-center">
            ...
            <p className="leading-relaxed mb-6 text-psicopiloto-gray-500">
              No tienes que hacerlo todo hoy ni solo. A veces lo más difícil es
              animarse a empezar, pero también es el paso que abre nuevas
              posibilidades. Enhorabuena, tu ya has dado ese primer paso, ahora stoy aquí para escucharte y acompañarte en tu
              viaje.
            </p>
