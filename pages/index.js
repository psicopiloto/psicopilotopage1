  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-psicopiloto-sand-50 text-psicopiloto-gray-700 relative">
      ...
      <main className="flex-grow pt-16 relative z-10">
        ...
        {/* Sección: Psicopiloto para Empresas */}
        <section className="py-16 bg-white/40">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            <h2 className="text-3xl font-semibold mb-6 text-psicopiloto-blue-600">
            ...
            <p className="text-xl text-psicopiloto-gray-500 mb-8 max-w-3xl mx-auto">
              Transfiere la mentalidad de cabina (CRM, Liderazgo, Gestión del Estrés) a tu
              equipo. Mejora la comunicación, toma de decisiones bajo presión y el bienestar
              de tu organización.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 bg-white/70 rounded-2xl shadow-xl transition transform hover:-translate-y-1">
              <div className="flex flex-col h-full">
                ...
                <p className="leading-relaxed mb-4 text-psicopiloto-gray-700">
                  ...
                  (gestión de crisis, factores humanos y liderazgo) se integra en la terapia para
                  ofrecerte un enfoque sólido y práctico.
                </p>
              ...
              <div className="flex flex-col h-full">
                ...
                <p className="leading-relaxed mb-4 text-psicopiloto-gray-700">
                  El objetivo es que recuperes la seguridad y la dirección en tu vida. Mi compromiso es
                  ofrecerte un espacio de confianza, utilizando terapia integradora y EMDR para que
                  recuperes el control de tus emociones.
                </p>
                <div className="mt-auto pt-4">
                  <AnimatedCTA
          ...
          <div className="container mx-auto max-w-5xl text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="p-6 bg-psicopiloto-sand-50 rounded-lg shadow-sm border border-psicopiloto-gray-500/10 transition transform hover:-translate-y-1"
                >
