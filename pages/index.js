          ...
          <div className="container mx-auto max-w-5xl relative">
            ...
            <Image
              ...
              className={`
                ...
                z-10 // Mantenemos un Z-index bajo para la imagen
              `}
            />

            {/* Grid solo para el texto - FIX: bg-white opaco y z-30 */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center p-8 bg-white rounded-2xl shadow-xl relative z-30"> 
