    ...
    <div className="min-h-screen flex flex-col font-sans bg-psicopiloto-sand-50 text-psicopiloto-gray-700 relative">
      ...
      <main className="flex-grow pt-16 relative z-10">
        <div className="container mx-auto p-6 bg-white/40 rounded-2xl shadow-lg">
          ...
          {/* ESTRUCTURA GRID UNIFICADA (Permite reordenar libremente en móvil) */}
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-start">
            
            {/* 1. TEXTO INTRO (Móvil: Posición 1 | Desktop: Izquierda Arriba) */}
            ...
            {/* 2. CALENDARIO (Móvil: Posición 2 | Desktop: Derecha Abajo) */}
            {/* 'md:row-start-2' fuerza que en escritorio se vaya abajo a la derecha */}
            <div className="bg-white/70 p-6 rounded-xl shadow-md order-2 md:col-start-2 md:row-start-2">
            ...
            {/* 3. CONTACTO DIRECTO (Móvil: Posición 3 | Desktop: Derecha Arriba) */}
            {/* 'md:row-start-1' fuerza que en escritorio se vaya arriba a la derecha */}
            <div className="bg-white/70 p-6 rounded-xl shadow-md space-y-2 order-3 md:col-start-2 md:row-start-1">
            ...
            {/* 4. FORMULARIO (Móvil: Posición 4 | Desktop: Izquierda Abajo) */}
            <div className="bg-white/70 p-6 rounded-xl shadow-md order-4 md:col-start-1">
            ...
            {/* LEGAL (Móvil: Posición 5 | Desktop: Derecha Fondo) */}
            <div className="text-sm text-psicopiloto-gray-700 order-5 md:col-start-2">
