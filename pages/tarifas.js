        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <section className="mb-20 bg-white/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-md border border-gray-100 max-w-4xl mx-auto">
            ...
            <div className="mt-12 pt-8 border-t border-gray-100 flex items-start gap-4 text-sm text-psicopiloto-gray-500 italic">
              ...
              <p>Para maximizar el beneficio del procesamiento EMDR, asegúrate de estar en un lugar adecuado donde puedas expresarte con total libertad, confidencialidad y sin interrupciones.</p>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
              {planesTarifas.map((plan, i) => (
                ...
                >
                  ...
                  <ul className={`space-y-3 mb-8 text-md md:text-base text-psicopiloto-gray-700 grid ${plan.fullWidth ? 'md:grid-cols-2 md:gap-x-8 md:space-y-0 gap-y-3' : 'grid-cols-1'}`}>
              ...
              <details name="faq-acordeon" className="group bg-white/80 rounded-xl p-5 shadow-sm border border-gray-100 [&_summary::-webkit-details-marker]:hidden">
                ...
                <div className="mt-4 text-md md:text-base text-psicopiloto-gray-600 leading-relaxed space-y-3 text-justify">
                  ...
                  <ul className="list-disc list-inside space-y-2 pl-1">
                    ...
                    <li>Trastornos de la realidad de perfil psicótico o brotes agudos en fase activa.</li>
                  </ul>
                  <p className="pt-2 font-semibold text-psicopiloto-gray-700">
                    En caso de encontrarte ante una crisis de urgencia sanitaria o una situación de riesgo inminente para tu integridad, debes acudir de inmediato a los servicios médicos de urgencia de tu localidad o al centro hospitalario más cercano.
                  </p>
                </div>
              </details>
