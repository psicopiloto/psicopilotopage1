        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-2xl font-semibold mb-4">¿Qué es Psicopiloto?</h2>
                <p>
          ...
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4">Nuestra visión</h2>
                <p>
          ...
          <section className="mb-16">
            <div>
              <h2 className="text-2xl font-semibold mb-4">¿Qué te ofrece Psicopiloto?</h2>
          ...
          <section className="mb-16">
            <div>
              <h2 className="text-2xl font-semibold mb-4">Valores que nos guían</h2>
              <p>La aviación me enseñó principios que hoy aplico en psicoterapia y consultoría empresarial:</p>
          ...
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-2xl font-semibold mb-4">Psicopiloto para empresas</h2>
                <p>
          ...
          <section className="mb-16">
            <div>
              <h2 className="text-2xl font-semibold mb-4">Psicopiloto para ti</h2>
              <p>
          ...
          <section className="text-center">
            <h2 className="text-2xl font-semibold mb-6">Da el primer paso</h2>
            <p className="mb-6">
