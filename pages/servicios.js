          ...
          <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-psicopiloto-gray-700">
              ...
              <div className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition">
                ...
                <p className="mb-4">
                  La <strong>ansiedad</strong> y el <strong>estrés</strong> son respuestas naturales del cuerpo, pero cuando se vuelven constantes pueden causar{" "}
                  <strong>insomnio</strong>, <strong>tensión muscular</strong> y una sensación de estar siempre en alerta.
                </p>
                <p className="mb-4">
                  En <strong>Psicopiloto</strong> te acompaño a comprender lo que te ocurre y a desarrollar{" "}
                  <strong>herramientas prácticas</strong> para reducir la ansiedad, mejorar tu descanso y recuperar la calma en tu día a día.
                </p>
                <Link href="/contacto">
              ...
              <div className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition">
                ...
                <p className="mb-4">
                  Sentirse sin energía, desmotivado o con <strong>tristeza persistente</strong> no es simplemente “estar de bajón”. La{" "}
                  <strong>depresión</strong> puede afectar a tu manera de pensar, sentir y relacionarte.
                </p>
                <p className="mb-4">
              ...
              <div className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition">
                ...
                <p className="mb-4">
                  Las <strong>relaciones de pareja</strong> pueden atravesar discusiones frecuentes, pérdida de confianza o{" "}
                  <strong>distanciamiento emocional</strong>. Si no se abordan, estas dificultades pueden generar una gran desconexión.
                </p>
                <p className="mb-4">
              ...
              <div className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition">
                ...
                <p className="mb-4">
                  Las <strong>experiencias dolorosas del pasado</strong> pueden dejar <strong>huellas profundas</strong> en la memoria y en el cuerpo, apareciendo en forma de{" "}
                  <strong>bloqueos emocionales</strong>, recuerdos intrusivos o sensación de amenaza constante.
                </p>
                <p className="mb-4">
                  En <strong>Psicopiloto</strong> aplico enfoques basados en la evidencia como la <strong>terapia EMDR</strong> y técnicas de regulación que ayudan a{" "}
                  <strong>procesar y liberar memorias traumáticas</strong> de manera <strong>segura y progresiva</strong>.
                </p>
                <p className="mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-psicopiloto-gray-700">
              <div className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition">
                ...
                <p className="mb-4">
                  ...
                  <strong>cohesión, confianza y liderazgo positivo</strong> para alcanzar sus objetivos. En{" "}
                  <strong>Psicopiloto</strong> aplicamos los principios de la aviación al desarrollo organizacional.
                </p>
                <p className="mb-4">
                  Nuestros programas de <strong>psicología aplicada a empresas</strong> ayudan a reducir errores, mejorar la eficiencia y fomentar una{" "}
                  <strong>comunicación clara</strong>, potenciando tanto a líderes como a equipos.
                </p>
                <p className="mb-4">
                  Los mismos principios que hacen que un vuelo sea seguro pueden transformar también tu empresa, aportando{" "}
