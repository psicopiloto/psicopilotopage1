...
export default function Nav() {
  ...
  return (
    // 🚀 CORRECCIÓN: Subido a z-50 para que el menú siempre esté por encima del WhatsApp flotante
    <nav className="fixed w-full bg-psicopiloto-sand-50/95 backdrop-blur z-50 shadow-md" aria-label="Navegación principal del sitio">
